...
<head>
    ...
    <link rel="stylesheet" href="./css/free_notice.css">
...
<body>
    <div id="wrap">
        ...
        <div class="content">
					...
					<table style="background-color:white;">
						...
						<tbody>
							...
							<tr>
								...
								<td class="title"><a href="free_notice_view.php?idx=<?php echo $row['idx']?>"><?php echo $row['title']?></a></td>
            ...
            <a href="./free_notice_write.php"><button>write</button></a>
			</div>
        </div>
