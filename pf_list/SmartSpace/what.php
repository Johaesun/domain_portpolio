...
<body onload="initialize()">
 <nav class="navbar navbar-default navbar">
  <div class="container">
   <h1>SmartSpace<small>-weathermap</small></h1>
  </div>
</nav>
	<div id="map" style="width:50%; height:85%;"></div>
<div class="navbar navbar-default navbar" id="left" style="text-align: center;">
    <h2>구글맵과 Open Weather Map을<br> 활용한 날씨지도</h2>
    <p>우측에 구글지도에 있는 마커를 클릭하면<br> 그 지역의 날씨정보를 볼수 있습니다.</br></p>
    
</div>
   <div class="navbar navbar-default navbar" id= "leftside" style="text-align: center;">
       <h2> 기준</h2>
    <h3><p>각각의 객체의 위치는 각각의 <br>객체의 시청의 기준입니다.</p>
    </h3>
              <p>서울:위도:37.566949 <br>경도:126.978056</p>
